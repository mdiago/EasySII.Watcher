...
namespace EasySII.Watcher.Xml.SIICreators
{
	...
	/// 
	/// </summary>
	public class FRIvaImportacionAduanasLC : FRIvaBase
	{
        ...
        /// <summary>
        /// Construye una nueva instancia de la clase FRIvaImportacionAduanasLC.
        /// </summary>
        public FRIvaImportacionAduanasLC() : base()
		{
		}
		...
		internal override APInvoice GetAPInvoice()
		{
			...
			facturaRecibida.InvoiceType = InvoiceType.LC;
