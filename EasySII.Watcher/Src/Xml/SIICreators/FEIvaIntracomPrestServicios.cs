...
namespace EasySII.Watcher.Xml.SIICreators
{
	...
	/// <summary>
	/// Facturas emitidas por prestaciones de servicios intracomunitarias.
	/// </summary>
	public class FEIvaIntracomPrestServicios : FEIvaIntracomEntrega
	{

		/// <summary>
		/// Construye una nueva instancia de la clase FRIvaNacionalNormal.
		/// </summary>
		public FEIvaIntracomPrestServicios() : base()
		{
		}
